...
14. 환자는 부작용을 여러 개 선택할 수 있고 여러 백신부작용증상을 여러 환자가 선택할 수 있다.
15. 환자는 백신 종류 한 가지만 예약하여 접종할 수 있다.
16. 환자는 백신을 접종하면 접종 기록에 남고 접종 기록은 환자 한 명이 1차 접종할 때 마다 기록 하나가 생긴다.
17. 접종기록에서 감염전적은 감염되었을 때 감염여부에 따라 O라고 표시되고 감염되지 않았을 경우 X라고 표시된다. 
18. 감염된 전적이 있는 환자는 접종 기록에 표시가 된다.
