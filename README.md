...
13. 각각 제품종류의 백신을 여러 개 __*공급*__하지만 백신은 한 가지만 접종할 수 있다.
14. 환자는 __*부작용*__을 여러 개 선택할 수 있고 하나의 백신부작용증상을 여러 환자가 선택할 수 있다.
15. 환자는 백신 종류 한 가지만 __*예약*__하여 접종할 수 있다.
16. 환자는 백신을 __*접종*__하면 접종 기록에 남고 접종 기록은 환자 한 명이 1차 접종할 때 마다 기록 하나가 생긴다.
17. 접종기록에서 감염전적은 감염되었을 때 __*감염여부*__에 따라 O라고 표시되고 감염되지 않았을 경우 X라고 표시된다. 
